﻿<#if (isSearch?exists && isSearch == "true")>
	<#if order == "addDate">
		<#assign href="<a href=\"${base}/front/searchGlasses.action?order=price&pageIndex=${pageIndex}\">按价格排序</a>"/>
	</#if>
	<#if order == "price">
		<#assign href="<a href=\"${base}/front/searchGlasses.action?order=addDate&pageIndex=${pageIndex}\">按到货时间排序</a>"/>
	</#if>
</#if>
<@flayout.myLayout "酷镜列表&nbsp;&nbsp;&nbsp;&nbsp;${href!!}">
<div>
																	...
																	<TR>
																		...
																		<TABLE class="table_pic_width" border=0
																			...
																			<TBODY>
																				<TR>
																					<TD class=image><A
																						href="${base}/front/detail.action?id=${item.id}"><IMG
																			...
																			<TBODY>
																				<TR>
																					<TD style="HEIGHT: 28px" class=vam><SPAN><A
																						href="${base}/front/detail.action?id=${item.id}">${item.name}</A></SPAN></TD>
																				</TR>
																				<TR>
																				...
																				<TR>
																					<TD style="HEIGHT: 21px" class=vam><A
																						...
																						href="${base}/front/addComment.action?glassesId=${item.id}"><IMG
																						border=0 alt=""
