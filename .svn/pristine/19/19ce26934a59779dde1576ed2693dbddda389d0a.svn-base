									...
									<TABLE
										...
										<TBODY>
											<TR>
												...
												<UL id="menu">
													<LI class=bg_list><A href="${base}/admin/userList.action">用户管理</A>
													</LI>
												</UL>
												</TD>
											</TR>
											<TR>
												<TD
													style="BORDER-BOTTOM: #ffffff 4px solid; BORDER-LEFT: #ffffff 7px solid; BORDER-TOP: #ffffff 5px solid; BORDER-RIGHT: #ffffff 7px solid">
												<UL id="menu">
													<LI class=bg_list><A href="${base}/admin/goSearch.action">眼镜管理</A>
													</LI>
												</UL>
												</TD>
											</TR>
											<TR>
												<TD
													style="BORDER-BOTTOM: #ffffff 4px solid; BORDER-LEFT: #ffffff 7px solid; BORDER-TOP: #ffffff 5px solid; BORDER-RIGHT: #ffffff 7px solid">
												<UL id="menu">
													<LI class=bg_list><A href="${base}/front/home.action">返回前台</A>
													</LI>
												</UL>
												</TD>
											</TR>
