												...
												<TABLE border=0 cellSpacing=0 cellPadding=0>
													<TBODY>
														<TR>
															...
															<SPAN class=productSpecialPrice>RMB ${glasses.price}</SPAN></DIV>
															</TD>
														</TR>
													</TBODY>
												</TABLE>
										...
										<TBODY>
											<TR>
												<TD class="main bg_input"><A
													href="${base}/admin/goUpdateGlasses.action?id=${glasses.id}"><IMG
													title=" update " border=0 alt=update
													src="${base}/images/update3.jpg" width=55 height=22></A>
									
													<A href="${base}/admin/deleteGlasses.action?id=${glasses.id}"  onclick="return confirm('确定删除该酷镜？')"><IMG
													title=" delete " border=0 alt=remove
													src="${base}/images/remove2.gif" width=55 height=22></A>
													
													<A href="${base}/admin/searchGlasses.action?pageIndex="1"><IMG
													title="back" border=0 alt=back
													src="${base}/images/button_add_to_cart2.gif" width=55 height=22></A>
													</TD>
											</TR>
										</TBODY>
									</TABLE>
